...
TEST_F(AdminCliTest, TestDescribeTable) {
  ...
  ASSERT_STR_CONTAINS(
      ...
      " OVERWRITE  \"hello\" \"hello\",\n"
      "    bool_val BOOL NULLABLE AUTO_ENCODING DEFAULT_COMPRESSION"
      " OVERWRITE  false false,\n"
      "    float_val FLOAT NULLABLE AUTO_ENCODING DEFAULT_COMPRESSION"
      " OVERWRITE  - -,\n"
      "    double_val DOUBLE NULLABLE AUTO_ENCODING DEFAULT_COMPRESSION"
      " OVERWRITE  123.4 123.4,\n"
